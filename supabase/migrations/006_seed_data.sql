-- ============================================================
-- JobAiro — Seed Data Migration (006)
-- Run in Supabase SQL Editor to populate sample jobs
-- ============================================================
...
- Deep understanding of browser rendering, performance profiling
...
- Support the Ambassador programme — recruiting, onboarding, and recognising top contributors
- Report community sentiment and feedback to the product team

Requirements:
- 1–2 years of community management or social media experience
- Passionate Notion user with deep knowledge of the product
